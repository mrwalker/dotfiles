...
" Move left, push left to bottom, rotate top to bottom, move down, push bottom
" to left
command RotateWindows :wincmd h | :wincmd J | :wincmd R | :wincmd j | :wincmd H
noremap \r :RotateWindows<CR>

colorscheme koehler
set go-=m
set go-=T

" Always start in adtuition project
cd ~/adtuition
